...
MD_PATH = BASE_DIR / "关系模式候选码求解解题过程.md"
PDF_PATH = BASE_DIR / "关系模式候选码求解解题过程.pdf"
IMG_DIR = BASE_DIR / "images"
QUESTION_IMG = IMG_DIR / "关系模式候选码求解-题目截图.png"
...
def make_question_image(path):
    img = PILImage.new("RGB", (1400, 190), "white")
    draw = ImageDraw.Draw(img)
    font = load_font(26)
    text = "已知关系R（a,b,c,d）和R上的函数依赖F=（a->cd，c->b），则R的候选码是（ ）。"
    draw_wrapped(draw, text, (42, 70), font, 1320)
