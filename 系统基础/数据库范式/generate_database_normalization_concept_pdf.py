...
MD_PATH = BASE_DIR / "数据库范式-概念讲解.md"
PDF_PATH = BASE_DIR / "数据库范式-概念讲解.pdf"
...
def make_styles(font_name):
    ...
    styles.add(ParagraphStyle(name="CnBody", parent=styles["BodyText"], fontName=font_name, fontSize=9.8, leading=15, spaceAfter=4))
    ...
    styles.add(ParagraphStyle(name="CnCode", parent=styles["Code"], fontName=font_name, fontSize=8.8, leading=12.5, backColor=colors.HexColor("#f3f4f6"), borderColor=colors.HexColor("#e5e7eb"), borderWidth=0.6, borderPadding=4.5, spaceBefore=2.5, spaceAfter=5))
    return styles
