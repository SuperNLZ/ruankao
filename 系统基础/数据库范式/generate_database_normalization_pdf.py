...
MD_PATH = BASE_DIR / "数据库范式-快速记忆.md"
PDF_PATH = BASE_DIR / "数据库范式-快速记忆.pdf"
...
def make_styles(font_name):
    ...
    styles.add(ParagraphStyle(name="CnTitle", parent=styles["Title"], fontName=font_name, fontSize=21, leading=30, alignment=TA_CENTER, spaceAfter=12))
    ...
    styles.add(ParagraphStyle(name="CnCode", parent=styles["Code"], fontName=font_name, fontSize=9.1, leading=13, backColor=colors.HexColor("#f3f4f6"), borderColor=colors.HexColor("#e5e7eb"), borderWidth=0.6, borderPadding=5, spaceBefore=3, spaceAfter=6))
    return styles
